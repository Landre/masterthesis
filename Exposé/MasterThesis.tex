...
\include{problemstellung}  % Einleitung
\include{zielsetzung}  % Grundlagen
\include{forschungsstand}     % Analyse
\include{konzept}     % Entwurf
\include{gliederung}    % Implementierung
\include{zeitplan}        % Evaluierung
