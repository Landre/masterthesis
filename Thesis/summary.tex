...
Zunächst werden die zugehörigen Daten der Methode des \emph{TherapyBuilders} untersucht. Wie in Abbildung \ref{spruenge} zu erkennen ist, wird der Konversationsverlauf, ähnlich eines herkömmlichen Chatverlaufs bekannter Technologien, versetzt dargestellt. 
