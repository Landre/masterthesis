...
\begin{figure}[h]
\centering
\missingfigure{Bild der grafischen Programmiersprachen}
...
\begin{figure}[h]
\centering
\missingfigure{Bilder der Chatbot-Plattformen}
\caption{Unterschrift}
\label{chatPlat}
\end{figure}
...
\begin{figure}[h]
\centering
\missingfigure{Bild der allgemeinen grafischen Programmiersprachen}
\caption{Unterschrift}
\label{allgGrafProg}
\end{figure}
...
\begin{figure}[h]
\centering
\missingfigure{Bild der Auszeichnungssprachen}
\caption{Unterschrift}
\label{auszSpra}
\end{figure}
...
\begin{figure}[h]
\centering
\missingfigure{Bild der Experience Sampling Tools}
\caption{Unterschrift}
\label{expSa}
\end{figure}
